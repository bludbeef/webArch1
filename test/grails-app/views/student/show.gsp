	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.book}">
				<li class="fieldcontain">
					<span id="book-label" class="property-label"><g:message code="student.book.label" default="Book" /></span>
					
						<g:each in="${studentInstance.book}" var="b">
